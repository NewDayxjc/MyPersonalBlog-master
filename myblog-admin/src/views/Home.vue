		...
		>
			<el-form  label-width="80px">
				...
				<el-form-item label="密码">	
					<el-input clearable show-password v-model="user.password"></el-input>
				</el-form-item>
			</el-form>
			<span slot="footer" class="dialog-footer">
				<el-button type="primary" @click="loginDialogOpen(1)">确 定</el-button>
			</span>	
		</el-dialog>
...
<script>
	import { loginUser,checkLogin,isLogout } from '@/api/userApi'
	export default {
		data() {
			return {
				pinCode:null,
		...
		methods: {
			...
			login(){
				loginUser(this.user).then( result =>{
					if(result.data.code == 200){
					  this.$message({
						message: '登陆成功',
						type: 'success'
